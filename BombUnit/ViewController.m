...
- (void)guess:(id)sender {
	...
	switch (hiddenLocation) {
		...
		case 4:
			...
			break;
		case 5:
			blastZone = @[@"0", @"1", @"6", @"10", @"11"];
			break;
		case 6:
			blastZone = @[@"0", @"1", @"2", @"5", @"7", @"10", @"11", @"12"];
			break;
		case 7:
			blastZone = @[@"1", @"2", @"3", @"6", @"8", @"11", @"12", @"13"];
			break;
		case 8:
			blastZone = @[@"2", @"3", @"4", @"7", @"9", @"12", @"13", @"14"];
			break;
		case 9:
			blastZone = @[@"3", @"4", @"8", @"13", @"14"];
			break;
		case 10:
			blastZone = @[@"5", @"6", @"11", @"15", @"16"];
			break;
		case 11:
			blastZone = @[@"5", @"6", @"7", @"10", @"12", @"15", @"16", @"17"];
			break;
		case 12:
			blastZone = @[@"6", @"7", @"8", @"11", @"13", @"16", @"17", @"18"];
			break;
		case 13:
			blastZone = @[@"7", @"8", @"9", @"12", @"14", @"17", @"18", @"19"];
			break;
		case 14:
			blastZone = @[@"8", @"9", @"13", @"18", @"19"];
			break;
		case 15:
			blastZone = @[@"10", @"11", @"16", @"20", @"21"];
			break;
		case 16:
			blastZone = @[@"10", @"11", @"12", @"15", @"17", @"20", @"21", @"22"];
			break;
		case 17:
			blastZone = @[@"11", @"12", @"13", @"16", @"18", @"21", @"22", @"23"];
			break;
		case 18:
			blastZone = @[@"12", @"13", @"14", @"17", @"19", @"22", @"23", @"24"];
			break;
		case 19:
			blastZone = @[@"13", @"14", @"18", @"23", @"24"];
			break;
		case 20:
			blastZone = @[@"15", @"16", @"21"];
			break;
		case 21:
			blastZone = @[@"15", @"16", @"17", @"20", @"22"];
			break;
		case 22:
			blastZone = @[@"16", @"17", @"18", @"21", @"23"];
			break;
		case 23:
			blastZone = @[@"17", @"18", @"19", @"22", @"24"];
			break;	   
		case 24:
			blastZone = @[@"18", @"19", @"23"];
			break;
...
- (void) checkAchievements{
	...
	switch (self.difficultLv) {
		case 1:
            identifier = kAchievementID1;
            percentComplete = 100.0;
            break;
		case 2:
            identifier = kAchievementID2;
            percentComplete = 100.0;
            break;
		case 3:
            identifier = kAchievementID3;
            percentComplete = 100.0;
            break;
		case 4:
            identifier = kAchievementID4;
            percentComplete = 100.0;
            break;
		case 5:
            identifier = kAchievementID5;
            percentComplete = 100.0;
            break;
		case 6:
            identifier = kAchievementID6;
            percentComplete = 100.0;
            break;
		case 7:
            identifier = kAchievementID7;
            percentComplete = 100.0;
            break;
		case 8:
            identifier = kAchievementID8;
            percentComplete = 100.0;
            break;
		case 9:
            identifier = kAchievementID9;
            percentComplete = 100.0;
            break;
		case 10:
            identifier = kAchievementID10;
            percentComplete = 100.0;
            break;
		case 11:
            identifier = kAchievementID11;
            percentComplete = 100.0;
            break;
		case 12:
            identifier = kAchievementID12;
            percentComplete = 100.0;
            break;
		case 13:
            identifier = kAchievementID13;
            percentComplete = 100.0;
            break;
	}
